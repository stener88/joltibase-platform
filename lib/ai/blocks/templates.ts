...
export const PRODUCT_LAUNCH_PREMIUM: BlockTemplate = {
  ...
  blocks: [
    ...
    {
      type: 'logo',
      content: { imageUrl: '{{logo_url}}', altText: 'Company Logo', linkUrl: '{{website_url}}' },
      settings: {
        align: 'center',
        width: '150px',
    ...
    },
    {
      ...
      settings: {
        ...
        containerPadding: { top: 32, bottom: 32, left: 40, right: 40 },
      },
      position: 8,
    },
    {
  ...
  blocks: [
    ...
    },
    {
      ...
      settings: {
        ...
        containerPadding: { top: 24, bottom: 24, left: 20, right: 20 },
      },
      position: 6,
    },
    {
