/**
 * Two Column 40/60 Layout Configuration
 * 
 * Side-by-side layout with narrower left column (40%) and wider right column (60%).
 * Elements: image, title, paragraph, button
 */

import type { LayoutConfig } from './types';

export const twoColumn4060Config: LayoutConfig = {
  id: 'two-column-40-60',
  name: 'Two Columns (40/60)',
  description: 'Side-by-side layout with 40% left, 60% right columns',
